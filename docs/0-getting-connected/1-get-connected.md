...
Now that you have created your project, you're ready to create a workbench. Click the link below to proceed:

* [🖥️ Create Workbench](0-getting-connected/2-create-workbench.md)
